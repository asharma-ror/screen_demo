class AvailableController < UIViewController
  ...
  def viewDidLoad
    ...
    rightButton = UIBarButtonItem.alloc.initWithTitle("Quote", style: UIBarButtonItemStyleBordered, target:self, action:'push')
  ...
  def push
    quoteController = QuoteController.alloc.initWithNibName(nil, bundle: nil)
